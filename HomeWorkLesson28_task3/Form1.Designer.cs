namespace HomeWorkLesson28_task3
{
    partial class Form1
    {
        /// <summary>
        ...
        {
            TreeNode treeNode1 = new TreeNode("Тримеры");
            ...
            TreeNode treeNode8 = new TreeNode("Водоснабжение, фильтрация, отопление ", new TreeNode[] { treeNode5, treeNode6, treeNode7 });
            ...
            treeNode8.Text = "Водоснабжение, фильтрация, отопление ";
